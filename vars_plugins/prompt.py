...
* It looks for a `questions.yaml` file, it just skip if is missing
* At the questions.yaml you put what you would put under vars_prompt
...
def write_answers_file(result):
    ...
    filename = "answers-{}.yaml".format(datetime.now().strftime("%Y%m%d%H"))
...
class VarsModule(BaseVarsPlugin):
    ...
    def _get_vars(self, loader, path, entities):
        ...
        try:
            ...
            display.display("[INFO] No questions.yaml, skipping")
            return result
